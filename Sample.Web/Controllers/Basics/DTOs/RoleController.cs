...
namespace Sample.Web.Controllers.Basics.DTOs
{
    ...
    public class RoleController : CustomBaseController<RoleDTO, RoleView, IRoleUpdateService, IRoleQueryService, long>
    {
        private readonly Lazy<IRoleQueryService> _entityQueryService;
        private readonly Lazy<IRoleUpdateService> _entityUpdateService;
        ...
        public RoleController(Lazy<IRoleQueryService> entityQueryService,
                                     Lazy<IRoleUpdateService> entityUpdateService,
