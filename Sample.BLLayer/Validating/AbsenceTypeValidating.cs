...
namespace Sample.BLLayer.Validating
{
    ...
    public class AbsenceTypeValidating : IAbsenceTypeValidating
    { 
        ...
        public AbsenceTypeValidating(Lazy<IAbsenceTypeQueryService> entityQueryService,
        ...
        public void Validate(AbsenceTypeDTO entityDTO, bool isNewEntity)
        {
