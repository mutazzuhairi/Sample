...
namespace Sample.BLLayer.Validating
{
    ...
    public class UserClaimValidating : IUserClaimValidating
    { 
        ...
        public UserClaimValidating(Lazy<IUserClaimQueryService> entityQueryService,
        ...
        public void Validate(UserClaimDTO entityDTO, bool isNewEntity)
        {
