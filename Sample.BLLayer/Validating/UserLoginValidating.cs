...
namespace Sample.BLLayer.Validating
{
    ...
    public class UserLoginValidating : IUserLoginValidating
    { 
        ...
        public UserLoginValidating(Lazy<IUserLoginQueryService> entityQueryService,
        ...
        public void Validate(UserLoginDTO entityDTO, bool isNewEntity)
        {
