...
namespace Sample.BLLayer.Validating
{
    ...
    public class BusinessValidating : IBusinessValidating
    { 
        ...
        public BusinessValidating(Lazy<IBusinessQueryService> entityQueryService,
        ...
        public void Validate(BusinessDTO entityDTO, bool isNewEntity)
        {
