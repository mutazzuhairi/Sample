...
namespace Sample.BLLayer.Validating
{
    ...
    public class AbsenceApprovalValidating : IAbsenceApprovalValidating
    { 
        ...
        public AbsenceApprovalValidating(Lazy<IAbsenceApprovalQueryService> entityQueryService,
        ...
        public void Validate(AbsenceApprovalDTO entityDTO, bool isNewEntity)
        {
