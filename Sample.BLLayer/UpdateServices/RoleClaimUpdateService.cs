...
namespace Sample.BLLayer.UpdateServices
{
    ...
    public class RoleClaimUpdateService : EntityUpdateService<RoleClaim, IRoleClaimRepositry, RoleClaimDTO, IRoleClaimMapping, IRoleClaimValidating, int>, IRoleClaimUpdateService
    {

        private readonly Lazy<IRoleClaimRepositry> _entityRepositry;
        private readonly Lazy<IRoleClaimValidating> _entityValidating;
        private readonly Lazy<IRoleClaimMapping> _entityMapping;
        ...
        public RoleClaimUpdateService(Lazy<IRoleClaimRepositry> entityRepositry,
                                    Lazy<IRoleClaimValidating> entityValidating,
                                    Lazy<IRoleClaimMapping> entityMapping,
