...
namespace Sample.BLLayer.UpdateServices
{
    ...
    public class UserTokenUpdateService : EntityUpdateService<UserToken, IUserTokenRepositry, UserTokenDTO, IUserTokenMapping, IUserTokenValidating, long>, IUserTokenUpdateService
    {

        private readonly Lazy<IUserTokenRepositry> _entityRepositry;
        private readonly Lazy<IUserTokenValidating> _entityValidating;
        private readonly Lazy<IUserTokenMapping> _entityMapping;
        ...
        public UserTokenUpdateService(Lazy<IUserTokenRepositry> entityRepositry,
                                    Lazy<IUserTokenValidating> entityValidating,
                                    Lazy<IUserTokenMapping> entityMapping,
