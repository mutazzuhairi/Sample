...
namespace Sample.BLLayer.UpdateServices
{
    ...
    public class BusinessUpdateService : EntityUpdateService<Business, IBusinessRepositry, BusinessDTO, IBusinessMapping, IBusinessValidating, long>, IBusinessUpdateService
    {

        private readonly Lazy<IBusinessRepositry> _entityRepositry;
        private readonly Lazy<IBusinessValidating> _entityValidating;
        private readonly Lazy<IBusinessMapping> _entityMapping;
        ...
        public BusinessUpdateService(Lazy<IBusinessRepositry> entityRepositry,
                                    Lazy<IBusinessValidating> entityValidating,
                                    Lazy<IBusinessMapping> entityMapping,
