...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class AbsenceApprovalQueryService : EntityQueryService<AbsenceApproval, IAbsenceApprovalRepositry, AbsenceApprovalDTO, AbsenceApprovalView, long>, IAbsenceApprovalQueryService
    {
        ...
        public AbsenceApprovalQueryService(Lazy<IAbsenceApprovalRepositry> entityRepositry, 
