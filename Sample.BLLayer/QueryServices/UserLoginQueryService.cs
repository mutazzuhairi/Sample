...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class UserLoginQueryService : EntityQueryService<UserLogin, IUserLoginRepositry, UserLoginDTO, UserLoginView, long>, IUserLoginQueryService
    {
        ...
        public UserLoginQueryService(Lazy<IUserLoginRepositry> entityRepositry, 
