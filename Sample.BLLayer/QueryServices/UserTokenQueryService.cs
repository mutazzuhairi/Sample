...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class UserTokenQueryService : EntityQueryService<UserToken, IUserTokenRepositry, UserTokenDTO, UserTokenView, long>, IUserTokenQueryService
    {
        ...
        public UserTokenQueryService(Lazy<IUserTokenRepositry> entityRepositry, 
