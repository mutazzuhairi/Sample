...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class UserRoleQueryService : EntityQueryService<UserRole, IUserRoleRepositry, UserRoleDTO, UserRoleView, long>, IUserRoleQueryService
    {
        ...
        public UserRoleQueryService(Lazy<IUserRoleRepositry> entityRepositry, 
