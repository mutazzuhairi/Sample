...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class RoleQueryService : EntityQueryService<Role, IRoleRepositry, RoleDTO, RoleView, long>, IRoleQueryService
    {
        ...
        public RoleQueryService(Lazy<IRoleRepositry> entityRepositry, 
