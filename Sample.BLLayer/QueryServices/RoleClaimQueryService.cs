...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class RoleClaimQueryService : EntityQueryService<RoleClaim, IRoleClaimRepositry, RoleClaimDTO, RoleClaimView, int>, IRoleClaimQueryService
    {
        ...
        public RoleClaimQueryService(Lazy<IRoleClaimRepositry> entityRepositry, 
