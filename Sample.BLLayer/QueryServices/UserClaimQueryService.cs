...
namespace Sample.BLLayer.QueryServices
{
    ...
    public class UserClaimQueryService : EntityQueryService<UserClaim, IUserClaimRepositry, UserClaimDTO, UserClaimView, int>, IUserClaimQueryService
    {
        ...
        public UserClaimQueryService(Lazy<IUserClaimRepositry> entityRepositry, 
