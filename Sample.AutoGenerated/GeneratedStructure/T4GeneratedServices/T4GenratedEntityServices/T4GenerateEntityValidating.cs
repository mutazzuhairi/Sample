...
{
    public class T4GenerateEntityValidating : IT4GeneratedSingleEntity
    {
        public void Generate(string tableName, TableInfo tableInfo, string folderName)
        {
            var fileConvention = AutoGeneratedConstatnts.FileConvention.VALIDATING;
            T4GeneratedArguments t4GeneratedArguments = new T4GeneratedArguments()
            {
                TableInfo = tableInfo,
                IsAlwaysGenerated = false,
                Class = typeof(EntitiesValidatingTemplate),
