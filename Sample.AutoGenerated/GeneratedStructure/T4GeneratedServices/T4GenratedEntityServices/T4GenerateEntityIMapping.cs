...
{
    public class T4GenerateEntityIMapping : IT4GeneratedSingleEntity
    {
        public void Generate(string tableName, TableInfo tableInfo, string folderName)
        {
            ...
            var lastFileConvention = AutoGeneratedConstatnts.FileConvention.MAPPING;
            T4GeneratedArguments t4GeneratedArguments = new T4GeneratedArguments()
            {
                TableInfo = tableInfo,
                IsAlwaysGenerated = false,
                Class = typeof(EntitiesIMappingTemplate),
