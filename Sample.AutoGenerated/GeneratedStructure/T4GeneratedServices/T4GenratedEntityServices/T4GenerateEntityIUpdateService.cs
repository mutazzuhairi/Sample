...
{
    public class T4GenerateEntityIUpdateService : IT4GeneratedSingleEntity
    {
        public void Generate(string tableName, TableInfo tableInfo, string folderName)
        {
            ...
            var lastFileConvention = AutoGeneratedConstatnts.FileConvention.UPDATE_SERVICE;
            T4GeneratedArguments t4GeneratedArguments = new T4GeneratedArguments()
            {
                TableInfo = tableInfo,
                IsAlwaysGenerated = false,
                Class = typeof(EntitiesIUpdateServiceTemplate),
