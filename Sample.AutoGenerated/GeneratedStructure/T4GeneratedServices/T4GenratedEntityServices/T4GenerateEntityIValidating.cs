...
{
    public class T4GenerateEntityIValidating : IT4GeneratedSingleEntity
    {
        public void Generate(string tableName, TableInfo tableInfo, string folderName)
        {
            ...
            var lastFileConvention = AutoGeneratedConstatnts.FileConvention.VALIDATING;
            T4GeneratedArguments t4GeneratedArguments = new T4GeneratedArguments()
            {
                TableInfo = tableInfo,
                IsAlwaysGenerated = false,
                Class = typeof(EntitiesIValidatingTemplate),
