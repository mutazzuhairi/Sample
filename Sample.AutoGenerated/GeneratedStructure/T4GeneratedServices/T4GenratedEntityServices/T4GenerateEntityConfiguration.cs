...
{
    public class T4GenerateEntityConfiguration : IT4GeneratedSingleEntity
    {
        public void Generate(string tableName, TableInfo tableInfo, string folderName)
        {
            var fileConvention = AutoGeneratedConstatnts.FileConvention.CONFIGURATION_GENERATED;
            T4GeneratedArguments t4GeneratedArguments = new T4GeneratedArguments()
            {
                TableInfo = tableInfo,
                IsAlwaysGenerated = true,
                Class = typeof(EntitiesConfigurationTemplate),
