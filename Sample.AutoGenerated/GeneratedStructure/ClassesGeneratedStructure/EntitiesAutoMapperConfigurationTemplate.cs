...
{
    public partial class EntitiesAutoMapperConfigurationTemplate : ITextTemplate
    {
        ...
        public EntitiesAutoMapperConfigurationTemplate(string nameSpace, TableInfo table)
